...
always_comb begin
	...
	if (~SWITCH_I[9]) flag = 4'h9;
	if (~SWITCH_I[8]) flag = 4'h8;
	if (~SWITCH_I[7]) flag = 4'h7;
	if (~SWITCH_I[6]) flag = 4'h6;
	if (~SWITCH_I[5]) flag = 4'h5;
	if (~SWITCH_I[4]) flag = 4'h4;
	if (~SWITCH_I[3]) flag = 4'h3;
	if (~SWITCH_I[2]) flag = 4'h2;
	if (~SWITCH_I[1]) flag = 4'h1;
	if (~SWITCH_I[0]) flag = 4'h0;
...
assign LED_GREEN_O[3:0] = {4'h00, value};
assign LED_GREEN_O[7:4] = {4'h00, flag};
